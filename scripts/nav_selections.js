...
function disable_links() {
    ...
    if (val == 0) {
        ...
        jQuery('#sideNav li a[href="view_detailed_results?operator=engineer"]').removeAttr("href");
        jQuery('#sideNav li a[href="view_detailed_results?operator=conductor"]').removeAttr("href");
