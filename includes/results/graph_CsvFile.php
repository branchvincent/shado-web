<?php
	...
	function createGraphCsv($assistant) {
		//
		// $file = fopen("results/stats_$assistant.csv", 'r') or die("Could not find $assistant file! Please return to check and update your settings.");
		// $d3_file = fopen("results/mod_type_data_$assistant.txt", 'w') or die ("Could not open $assistant file! Please return to check and update your settings.");
		//
		// $count=array();
		// $s_dev=array();
		// $temp_count_dev=0;
